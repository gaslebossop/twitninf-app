...
export default function CreateVideoScreen() {
  ...
  // ── Pick video ──
  const pickVideo = async (camera = false) => {
    const perm = camera
      ...
      <View style={styles.root}>
        ...
        <View style={styles.pickerCenter}>
          ...
          <View style={styles.selBtns}>
            <TouchableOpacity style={[styles.selBtn, styles.selBtnFilled, { backgroundColor: colors.accent }]} onPress={() => pickVideo(true)} activeOpacity={0.8}>
              <Ionicons name="camera" size={22} color={colors.white} />
              <Text style={styles.selBtnText}>Filmer</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.selBtn, styles.selBtnFilled, { backgroundColor: colors.surfaceAlt }]} onPress={() => pickVideo(false)} activeOpacity={0.8}>
