...
const styles = StyleSheet.create({
  ...
  closeButton: { width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.09)' },
  ...
  unitToggle: {
    ...
    backgroundColor: 'rgba(255,255,255,0.09)', borderWidth: 1, borderColor: colors.border, marginBottom: 10,
  },
